...
<script src="js/lzm/custDevelopPlan.js"></script>
<%-- 
<%
...
<body>
		...
		<tr>
			<td colspan="2" align="right">
				<div class="layui-input-inline">
					<a onclick="locationSalPlan()"
						class="layui-btn layui-btn-primary layui-btn-sm">执行计划 </a>
				</div>
				<div class="layui-input-inline">
					<a href="jsp/salChanceManager.jsp" class="layui-btn layui-btn-primary layui-btn-sm"> 返回 </a>
				</div>
			</td>
		</tr>
			...
			<td><label class="layui-form-label">机会来源</label>
				<div class="layui-input-inline">
					<input type="text" name="chcSource" class="layui-input"
						value="<%=request.getParameter("chcSource")%>"
			...
			<td><label class="layui-form-label">客户名称</label>
				<div class="layui-input-inline">
					<input type="text" name="chcCustName" class="layui-input"
						value="<%=request.getParameter("chcCustName")%>"
						readonly="readonly">
				</div></td>
			...
			<td><label class="layui-form-label">联系人</label>
				<div class="layui-input-inline">
					<input type="text" name="chcLinkman" class="layui-input"
						value="<%=request.getParameter("chcLinkman")%>"
						readonly="readonly">
				</div></td>
			...
			<td><label class="layui-form-label">创建人</label>
				<div class="layui-input-inline">
					<input type="text" readonly="readonly" name="chcCreateName"
						class="layui-input"
						value="<%=request.getParameter("chcCreateName")%>"> <input
						type="hidden" name="chcCreateId"
			...
			<td><label class="layui-form-label">指派人</label>
				<div class="layui-input-inline">
					<input type="text" name="chcDueName" readonly="readonly"
						class="layui-input"
						value="<%=request.getParameter("chcDueName")%>"> <input
						type="hidden" name="chcDueId"
	...
	<table class="layui-table">
		<tr>
			<td><label class="layui-form-label">计划项:</label>
				<div class="layui-input-inline">
					<input type="text" name="plaTodo" style="width: 600px"
						class="layui-input">
				</div>
				<div class="layui-input-inline">
	...
	<script type="text/html" id="tubiao">
		<div class="layui-input-inline">
			<button  lay-event="del" class="layui-btn layui-btn-primary layui-btn-sm">
